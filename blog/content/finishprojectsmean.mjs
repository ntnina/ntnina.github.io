...
const preRamble = autosplit(`
    I wrote <a href=\"/blog/view?finishprojects\">a post about productivity</a>. And this post was based off of a productivity system that I wrote in a series of markdown files ages ago. But I felt this "nice version" lacked a lot of the character and tough love that my original markdown files had.
...
if (typeof window !== "undefined") {
    ...
    stillRamble = await fetch("/blog/content/finish-projects-mean.md")
        .then(res => res.text())
...
export default {
    ...
    description: "My original musings on productivity - this is the mean version for people who like tough love. See <a href=\"/blog/view?finishprojects\">here</a> for a nicer version.",
